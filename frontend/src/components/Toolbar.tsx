...
export default function Toolbar() {
  ...
  const applyInterfaceMap = useStore((s) => s.applyInterfaceMap);
  const clearActualInterfaces = useStore((s) => s.clearActualInterfaces);
  ...
  const onDeploy = async () => {
    ...
    try {
      ...
      // Stamp actual interface names onto the edges so canvas labels and
      // the node info panel reflect what the kernel really named them.
      if (res.interfaceMap) applyInterfaceMap(res.interfaceMap);
